...
test('Search contact by phone Success', async() => {
    ...
    const searchphone = await driver.findElement(By.id('input2'));
    await searchphone.sendKeys('80-1796-3951');

});

test('Search contact by phone  Failed By: special characters', async() => {
    jest.setTimeout(100000);
    // Navigate to the login page
    await driver.get('http://54.227.58.35/login');
...
test('Search contact by phone Failed By: Contains alphanumeric characters', async() => {
    jest.setTimeout(100000);
    // Navigate to the login page
    await driver.get('http://54.227.58.35/login');
...
test('Search contact by phone Failed By: Contains space characters', async() => {
    jest.setTimeout(100000);
    // Navigate to the login page
    await driver.get('http://54.227.58.35/login');
...
test('Search contact by phone Failed By: Contains space characters: Exist Phone', async() => {
    jest.setTimeout(100000);
    // Navigate to the login page
    await driver.get('http://54.227.58.35/login');
